...
class Gui:
    ...
    def setup_gui(self):
        ...
        self.button_box2_5 = Button(self.box2_5, text="Reconnexion série cathode", bg='#3f3f3f', fg='lightblue', font=('Helvetica', 14), command=self.bouton_Reconnexion_serie_Cathode)
    ...
    def bouton_Reconnexion_serie_Cathode(self):
